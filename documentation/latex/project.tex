...
% \usepackage[demo]{graphicx} % black preview images
...
Class diagrams are a great to draw out a visual plan of what the system will look like. As I am using an ECS form of design, the class diagram will mainly consist of many classes with compositional relationships.
...
The project was created by going through these objectives and tackling them one at a time, breaking each task down when arriving to it, this way there was focused attention on each feature being added in and being tested and refined before moving on.
...
As can be seen in the figure showing the UI for creature, the meshes for the creatures were kept simple to ensure that the AI system worked, the movement system was also a trivial direct transformation towards the target for the same reason.
...
As seen in the PDD and the introduction, the souls-like genre is an influnce on this project, based on this, the Head was inspired from the games in that genre.\cite{darkSouls3Wiki}
\begin{figure}[H]
    \centering
